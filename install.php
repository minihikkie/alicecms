...
<div class="wizard">
  <div class="text-center mb-3">
    <div class="logo" style="margin:0 auto 12px;width:56px;height:56px;font-size:28px;border-radius:18px;"><span class="material-symbols-rounded filled">account_balance</span></div>
